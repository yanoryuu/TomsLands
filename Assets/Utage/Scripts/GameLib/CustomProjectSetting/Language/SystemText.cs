...
namespace Utage
{
	public enum SystemText
	{
		...
		UtageGuideMessageQuickSaveFailed,
		UtageGuideMessageQuickLoadFailed,
		UtageGuideMessageSaveFailed,
		UtageGuideMessageSaveDataLoadFailed,
		UtageDialogMessageSystemSaveDataReadFailedRetry,
