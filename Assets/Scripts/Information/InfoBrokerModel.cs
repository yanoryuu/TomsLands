...
public class InfoBrokerModel
{
    ...
    private readonly Dictionary<string, List<string>> specialDungeonMessages = new()
    {
        ...
        {
            "{0}�̃}�O�}�΍�ɂ��Ď��₵�Ă�����A�s���C���Ǝv��",
            "{0}�̉ΎR�̔M�ɂ��Ē��ׂĂ���B���킷�邩����",
            "�E�҂���A{0}�̃h���S���̂��ƋC�ɂ��Ă���"
        },
    ...
    private bool IsItemEffectiveForDungeon(ItemData item, DungeonData dungeon)
    {
        ...
        {
            DungeonName.IceMistCave => new[] { ItemTypeData.ItemAttribute.Fire }, // �X�ɉ΂��L��
            DungeonName.DeepGreenBeastForest => new[] { ItemTypeData.ItemAttribute.Fire, ItemTypeData.ItemAttribute.Light }, // �؂ɉ΁A�łɌ�
            DungeonName.ScorchingVolcanoPrison => new[] { ItemTypeData.ItemAttribute.Water }, // �΂ɐ����L��
            DungeonName.MausoleumOblivion => new[] { ItemTypeData.ItemAttribute.Light }, // �łɌ����L��
             // => new[] { ItemTypeData.ItemAttribute.Water, ItemTypeData.ItemAttribute.Earth }, // �@�B�ɐ��E�y���L��
    ...
    private float CalculateDungeonRiskFactor(DungeonData dungeon)
    {
        ...
        {
            DungeonName.IceMistCave => 0.9f,        // �Ɋ��_���[�W�ł��댯
            DungeonName.DeepGreenBeastForest => 1.0f,    // �W���I�Ȋ댯�x
            DungeonName.ScorchingVolcanoPrison => 0.8f,  // �}�O�}�_���[�W�Ŋ댯
            DungeonName.MausoleumOblivion => 0.7f, // ���|��ԂŔ��Ɋ댯
            // "dungeon_metalion" => 0.6f,        // �@�B�g���b�v�ōł��댯
            _ => 1.0f
        };
    }
    ...
    private string GenerateDungeonMessageText(string dungeonName, string dungeonId, float confidence)
    {
        ...
        // ���ʃ��b�Z�[�W�����邩�`�F�b�N
        string mainMessage;
        if (specialDungeonMessages.ContainsKey(dungeonId) && random.NextDouble() < 0.4) // 40%�̊m���œ��ʃ��b�Z�[�W
        {
