...
public class InfoBrokerModel
{
    ...
    {
        //氷霧の洞窟
        new DungeonData("dungeon_ice_mist", "氷霧の洞窟", 8, ItemTypeData.ItemAttribute.Fire, 4),
        
        //深緑の獣林
        new DungeonData("dungeon_beast_forest", "深緑の獣林", 12, ItemTypeData.ItemAttribute.Fire, 5),
        
        // 灼熱の火山牢
        new DungeonData("dungeon_volcano_prison", "灼熱の火山牢", 16, ItemTypeData.ItemAttribute.Water, 7),
